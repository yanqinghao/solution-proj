...
class Solution(SolutionBase):
    ...
    def model(self):
        ...
        reader1.set_title("data_input")

        customers_group = self.myscheme.new_node('customer_group.Customer_fcluster')
        customers_group.set_title('Customers_fcluster')
        ...
        # self.myscheme.new_link(customers_group, "Evaluation Results", eva_visualization, "Result")
        # self.myscheme.new_link(customers_group, "Metric Score", eva_visualization, "Metric Score")
        # self.myscheme.new_link(eva_visualization, "Evaluation", evaluation_writer, "Data")

        self.myscheme.new_link(reader1, "Data", customers_group, "Data")
        # self.myscheme.new_link(reader2, "Data", customers_group, "Test Data")
        self.myscheme.new_link(customers_group, "Grouped Data", outputwriter, "Data")
